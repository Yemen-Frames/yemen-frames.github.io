!(function () {
  ...
  function p(t) {
    var e = t.namespaceURI === y,
      r = "cf-marker-" + Math.random().toString().slice(2);
    t.setAttribute(r, "");
    var o = e ? "<svg>" + t.outerHTML + "</svg>" : t.outerHTML;
    S.call(document, o);
    ...
    var r = new _(e, {
      ...
      callback: function () {
        (window.__cfRLUnblockHandlers = !0),
          ...
          (function (t) {
            var e = new E(t);
            L.simulateStateBeforeDeferScriptsActivation(),
              e.harvestDeferScriptsInDocument(),
              new _(e, {
                nonce: t,
                blocking: !1,
                callback: function () {
                  L.simulateStateAfterDeferScriptsActivation(), O && O();
                },
              }).run();
          })(t);
      },
  ...
  var y = "http://www.w3.org/2000/svg",
    ...
    b = void 0 !== document.createElement("script").noModule,
    g = (function () {
      var t = window;
      return (
      ...
      return (
        ...
        (n.prototype.insertContentInHead = function () {
          ...
          if (
            ...
            for (
              var o = Array.prototype.slice.call(r.body.childNodes),
                i = this.insertionPointMarker.nextSibling;
              i;

            )
              o.push(i), (i = i.nextSibling);
            document.body || S.call(document, "<body>"),
              (function (t, e) {
        ...
        (n.prototype.write = function (t, e) {
          ...
          o && r(o) && o.hasAttribute("async")
            ? (n = e ? w : S).call.apply(n, [document].concat(t))
    ...
    _ = (function () {
      ...
      return (
        ...
        (e.prototype.activateScript = function (e) {
          ...
          var c = this.settings.blocking && o && !i ? p(n) : s(n);
          return c
